...
import pl.polsl.lab.web.services.reference.CalculationList;
...
public class ViewCalculations extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
          ...
          List<CalculationList> calcs = null;
        try {
            calcs = getCalculationList();
        } catch (WSException_Exception ex) { //db exception
